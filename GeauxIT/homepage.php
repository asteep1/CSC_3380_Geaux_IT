<!--Provides the homepage interface for the user. Loads all entries from the database into 
an html table. -->
...
<div class = "table">
<table id="table" cellpadding="0" cellspacing="0" width="97%">
<tr>
<th>Id</th>
<th>Title</th>
<th>Assigned</th>
...
$sql = "SELECT id, title, assigned_tech , user_message FROM Tickets";
