<!-- Edits a pre-existing entry in the database. Passes ID to database to select.  -->
...
$sql = "SELECT id, user_name, user_mail, title, assigned_tech , user_message, user_phone FROM Tickets WHERE id = $id";
